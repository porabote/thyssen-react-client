...
import TestSampleView from './test-sample-view'
                ...
                <div className="content feed">
                    ...
                    <div className="content__body">
                        <FeedList schema={this.state.schema}>
                            {data.map((row, index) => {
                                return(
                                    <FeedListRow dicts={this.state.dicts} key={index} to={`/test-sample/view/${row.id}`} schema={this.state.schema} data={row}></FeedListRow>
                                )
                            })}
                        </FeedList>
                    </div>
