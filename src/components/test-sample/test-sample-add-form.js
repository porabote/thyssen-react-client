...
class TestSampleAddForm extends Component {
        ...
        return (
            <div>
                ...
                <Form
                    ...
                    action="/api/test-sample/add/"
                    submitFormAfter={(resp) => {
                        window.location = `/porabote/test-sample/view/${resp.data.id}`
                    }}
                >
...
export default TestSampleAddForm