...
import { fetchRecordsThunk } from './test-sample-actions'
...
class TestSampleList extends Component {
                    ...
                    <FeedListBody {...this.props}>
                        {this.props.storage.map((data) => {
                            return <FeedListBodyRow
                                ...
                                linkTo={`/test-sample/view/${data.id}`}
                            />
                        })}
                    </FeedListBody>
                </FeedList>
...
const mapStateToProps = store => ({...store.test-sample})
...
export default connect(mapStateToProps, mapDispatchToProps)(ListWithData(TestSampleList, 'test-sample'))