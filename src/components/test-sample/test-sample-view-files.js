...
class TestSampleViewFiles extends Component {
    ...
    render() {
        ...
        return(
            <div>
                ...
                <ButtonUpload
                    progressBar={false}
                    uri='/api/test-sample/method/uploadReportFile/'
                    previewPanel={() => {
                        return(
                            <div>
                                <Field>
                                ...
                                <Field>
                                    <InputHidden name="model_alias" defaultValue="test-sample" />
                                </Field>
                            </div>
                        )
                    }}
...
export default TestSampleViewFiles