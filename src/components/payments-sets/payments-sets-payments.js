...
class PaymentsSetsPayments extends React.Component {
  ...
  fetchData = (query) => {
    ...
    Api.get(`/api/payments-sets/${this.props.data.id}/relationships/payments`, {
      query: {
        include: ["payments.contractor", "payments.client", "payments.bill", "payments.status"]
      }
    })
      .then((response) => {
        this.setState({
  ...
  render() {
    ...
    return (
      <div>
        ...
        <StripedList
          style={{ gridTemplateColumns: "50px 50px 150px 150px 1fr 150px 190px 150px 1fr 1fr" }}>
          ...
          <StripedListRow key="head" className="grid_list head">
            ...
            <StripedListCell className="grid_list__item head">принято в работу в
              ШГ</StripedListCell>
          ...
          {this.state.data.map((item, index) => {
            ...
            let shneiderStatus = typeof attrs.accept_datetime == "string" ? moment(attrs.accept_datetime)
              .format("DD MMM YYYY HH:mm") : null;
            ...
            return (
              <StripedListRow key={index}>
                    ...
                    {item.attributes.status_id == 55 &&
                      ...
                      <React.Fragment>
                        <div
                          style={{ display: "flex" }}
                          onClick={() => {
                            this.props.modalCancelRequestApprove(item, this.fetchData);
                          }}>
                        ...
                        <div style={{ display: "flex" }} onClick={() => {
                          this.props.modalCancelRequestDecline(item, this.fetchData);
                        }}>
                ...
                <StripedListCell>
                  <div>
                    <p>
                     <b> {typeof contractor.attributes != "undefined" && contractor.attributes.name}</b>
                    </p>
                    <p>
                      {typeof client.attributes != "undefined" && client.attributes.name}
                    </p>
                  </div>
                </StripedListCell>
  ...
  return {
    modalPaymentRepeat: (item, fetchData) => dispatch({
      ...
      payload: {
        ...
        content: React.createElement(PaymentRepeat, {
          item,
          fetchData
        })
      }
    ...
    modalPaymentCancel: (item, fetchData) => dispatch({
      ...
      payload: {
        ...
        content: React.createElement(PaymentCancel, {
          item,
          fetchData
        })
      }
    ...
    modalCancelRequestApprove: (item, fetchData) => dispatch({
      ...
      payload: {
        ...
        content: React.createElement(CancelRequestApprove, {
          item,
          fetchData
        })
      }
    ...
    modalCancelRequestDecline: (item, fetchData) => dispatch({
      ...
      payload: {
        ...
        content: React.createElement(CancelRequestDecline, {
          item,
          fetchData
        })
      }
