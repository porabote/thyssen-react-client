...
class SampleComponentAddForm extends Component {
    ...
    return (
      <div>
        ...
        <Form
          ...
          action="/api/sample-component/add/"
          submitFormAfter={(resp) => {
            window.location = `/porabote/sample-component/view/${resp.data.id}`
            //OR
...
export default connect(mapStateToProps)(SampleComponentAddForm)