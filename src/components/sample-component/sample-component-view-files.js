...
class SampleComponentViewFiles extends Component {
    ...
    render() {
        ...
        return(
            <div>
                ...
                <ButtonUpload
                    progressBar={false}
                    uri='/api/sample-component/method/uploadReportFile/'
                    previewPanel={() => {
                        return(
                            <div>
                                <Field>
                                ...
                                <Field>
                                    <InputHidden name="model_alias" defaultValue="sample-component" />
                                </Field>
                            </div>
                        )
                    }}
...
export default SampleComponentViewFiles