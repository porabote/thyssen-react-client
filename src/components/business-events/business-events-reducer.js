import { SET_RECORDS, FETCH_RECORDS } from './business-events-types'
...
const business-eventsReducer = (store = initialState, action) => {
...
export default business-eventsReducer