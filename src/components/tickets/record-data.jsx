  ...
  return (
    <div>
      ...
      <div className="links_with_icon__wrap" style={{justifyContent: 'flex-end'}}>
        ...
        {/*{status.id == 75 &&*/}
            <div className="link_with_icon" onClick={() => {
              let values = {...props.attrs}
              values.status_id = 76;
              props.setStatusAsBought(values, props.fetchData)
            }}>
              <CheckIcon style={{fontSize: '19px'}} className="link_with_icon__icon"/>
              Изменить статус на закуплено
            </div>        
        {/*}*/}
