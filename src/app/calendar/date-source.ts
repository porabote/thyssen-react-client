class DateSource {
  ...
  weekdays_less_list = ['Вс', 'Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб'];
  weekdays_list = ['Воскресенье', 'Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Суббота'];
  ...
  getWeeksList() {
    ...
    while (i < 365) {
      ...
      let title = weekNumber + '  (' + monday.getDate() + ' ' + this.monthsList[monday.getMonth()][0];
      monday.setDate(monday.getDate() + 6);
      title += ' - ' + monday.getDate() + ' ' + this.monthsList[monday.getMonth()][0] + ')';
